...
export function AuditPage({ refreshToken }: PageProps): JSX.Element {
  ...
  return (
    <div className="stack audit-light-v65 audit-safe-v66">
      <div className="page-title"><h1>Logs / Diagnóstico</h1><p>Alertas, trilhas de auditoria e diagnósticos sem esconder conteúdo no mobile.</p></div>
