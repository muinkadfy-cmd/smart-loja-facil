...
import { flushWebOutbox, getWebOutboxStats, getWebRoleCapabilities, getWebStoreContext, readWebSyncSnapshot, WEB_APP_VERSION, WEB_CACHE_VERSION, webRoleLabel, type WebOutboxStats, type WebStoreRole, type WebSyncSnapshot } from '../lib/webApi';
