...
export function BackupPage({ refreshToken, onChanged }: PageProps): JSX.Element {
  ...
  const description = runtimeInfo.isWeb
    ? 'Exporte um JSON com os dados da loja na nuvem e importe com confirmação dupla. O backup tenta embutir as fotos de produtos preparadas pelo app; se alguma ficar só por link/caminho, copie também o bucket product-photos ao migrar de projeto.'
