...
export function getCssInventoryReport(): CssInventoryReport {
  ...
  const items: CssInventoryItem[] = [
    ...
    },
    {
      ...
      detail: ruleCount > 4200 ? 'CSS ainda grande, mas os lotes 78–96 já isolaram camadas seguras, iniciaram consolidação do legado e adicionaram validação comercial.' : 'Quantidade lida pelo navegador está dentro do esperado para a base atual.',
