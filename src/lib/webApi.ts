...
export const WEB_APP_VERSION = 'pwa-supabase-v199-comprovante-tipografia-aberta';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v199-comprovante-tipografia-aberta';
