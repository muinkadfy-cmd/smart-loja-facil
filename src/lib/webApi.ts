...
export const WEB_APP_VERSION = 'pwa-supabase-v245-iphone-mobile-polimento';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v245-iphone-mobile-polimento';
