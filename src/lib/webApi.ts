...
export const WEB_APP_VERSION = 'pwa-supabase-v246-iphone-mobile-polimento';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v246-iphone-mobile-polimento';
