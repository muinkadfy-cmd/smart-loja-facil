...
export const WEB_APP_VERSION = 'pwa-supabase-v203-sora-sem-fonte-quebrada';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v203-sora-sem-fonte-quebrada';
