...
export const WEB_APP_VERSION = 'pwa-supabase-v213-crediario-compacto-premium';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v213-crediario-compacto-premium';
