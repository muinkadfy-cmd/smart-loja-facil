...
export const WEB_APP_VERSION = 'pwa-supabase-v218-pdv-premium-definitivo';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v218-pdv-premium-definitivo';
