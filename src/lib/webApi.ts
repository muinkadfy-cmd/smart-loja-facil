...
export const WEB_APP_VERSION = 'pwa-supabase-v194-extrato-fiel-central-avisos';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v194-extrato-fiel-central-avisos';
