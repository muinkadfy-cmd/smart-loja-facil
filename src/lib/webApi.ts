...
export const WEB_APP_VERSION = 'pwa-supabase-v188-comprovantes-acoes-fontes';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v188-comprovantes-acoes-fontes';
