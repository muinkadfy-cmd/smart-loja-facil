...
export const WEB_APP_VERSION = 'pwa-supabase-v159-crediario-notas-comprovantes';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v159-crediario-notas-comprovantes';
...
export async function webCommercialValidation(): Promise<WebCommercialValidationReport> {
  ...
  pushCommercialCheck(checks, {
    ...
    detail: cacheKeys.includes(WEB_CACHE_VERSION) ? 'Cache novo v159 encontrado neste aparelho.' : 'Cache novo ainda não apareceu; pode precisar abrir após deploy ou limpar cache antigo.',
