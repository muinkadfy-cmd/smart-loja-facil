...
export const WEB_APP_VERSION = 'pwa-supabase-v231-micro-ajuste-extrato-comprovante';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v231-micro-ajuste-extrato-comprovante';
