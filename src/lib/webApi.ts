...
export const WEB_APP_VERSION = 'pwa-supabase-v228-extratos-premium-legiveis';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v228-extratos-premium-legiveis';
