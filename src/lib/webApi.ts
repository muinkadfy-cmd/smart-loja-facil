...
export const WEB_APP_VERSION = 'pwa-supabase-v201-comprovante-fontes-maiores';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v201-comprovante-fontes-maiores';
