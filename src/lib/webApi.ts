...
export const WEB_APP_VERSION = 'pwa-supabase-v182-vendas-comprovante-pdf-png';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v182-vendas-comprovante-pdf-png';
...
export async function webCommercialValidation(): Promise<WebCommercialValidationReport> {
  ...
  pushCommercialCheck(checks, {
    ...
    detail: cacheKeys.includes(WEB_CACHE_VERSION) ? 'Cache novo v182 encontrado neste aparelho.' : 'Cache novo ainda não apareceu; pode precisar abrir após deploy ou limpar cache antigo.',
