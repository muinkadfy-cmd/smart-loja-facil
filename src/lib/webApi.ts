...
export const WEB_APP_VERSION = 'pwa-supabase-v195-avisos-responsivo-comprovante-sem-texto';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v195-avisos-responsivo-comprovante-sem-texto';
