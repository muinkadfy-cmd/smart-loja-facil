...
export const WEB_APP_VERSION = 'pwa-supabase-v197-comprovante-fiel-margens-ajustadas';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v197-comprovante-fiel-margens-ajustadas';
