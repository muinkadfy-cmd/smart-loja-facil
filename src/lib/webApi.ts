...
export const WEB_APP_VERSION = 'pwa-supabase-v206-comprovante-crediario-alinhado';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v206-comprovante-crediario-alinhado';
