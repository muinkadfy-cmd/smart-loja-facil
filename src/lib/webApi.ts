...
export const WEB_APP_VERSION = 'pwa-supabase-v107-dashboard-mobile-pixel';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v107-dashboard-mobile-pixel';
