...
export const WEB_APP_VERSION = 'pwa-supabase-v214-padrao-compacto-premium-abas';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v214-padrao-compacto-premium-abas';
