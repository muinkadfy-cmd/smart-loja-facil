...
export const WEB_APP_VERSION = 'pwa-supabase-v101';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v101-ultra-clean';
...
const WEB_OUTBOX_KEY = 'smart-loja:web-outbox-v101';
