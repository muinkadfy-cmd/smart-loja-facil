...
export const WEB_APP_VERSION = 'pwa-supabase-v106-dashboard-alerts';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v106-dashboard-alerts';
