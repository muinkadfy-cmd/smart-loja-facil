...
export const WEB_APP_VERSION = 'pwa-supabase-v226-comprovantes-legiveis-10x';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v226-comprovantes-legiveis-10x';
