...
export const WEB_APP_VERSION = 'pwa-supabase-v193-cupom-micro-ajuste-acima';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v193-cupom-micro-ajuste-acima';
