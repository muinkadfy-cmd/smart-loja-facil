...
export const WEB_APP_VERSION = 'pwa-supabase-v198-comprovante-top-ajuste-aberta';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v198-comprovante-top-ajuste-aberta';
