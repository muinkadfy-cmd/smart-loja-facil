...
export const WEB_APP_VERSION = 'pwa-supabase-v200-sora-comprovantes-unificados';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v200-sora-comprovantes-unificados';
