...
export const WEB_APP_VERSION = 'pwa-supabase-v211-ortografia-expansiveis-layout-premium';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v211-ortografia-expansiveis-layout-premium';
