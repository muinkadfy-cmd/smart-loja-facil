...
export const WEB_APP_VERSION = 'pwa-supabase-v196-comprovante-fiel-referencia';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v196-comprovante-fiel-referencia';
