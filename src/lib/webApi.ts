...
export const WEB_APP_VERSION = 'pwa-supabase-v227-crediario-clareza-total';
export const WEB_CACHE_VERSION = 'smart-loja-pwa-supabase-v227-crediario-clareza-total';
