...
export const PRODUCTION_CHECKLIST: ProductionCheckItem[] = [
  ...
  },
  {
    ...
    expected: 'Ao focar/atualizar, os dois mostram o mesmo cliente, produto, venda e saldo.',
    tone: 'supabase',
  },
  {
...
export function buildProductionChecklistText(state: ProductionCheckState): string {
  ...
  return [
    `Checklist comercial Lote 85: ${summary.done}/${summary.total} (${summary.percent}%)`,
