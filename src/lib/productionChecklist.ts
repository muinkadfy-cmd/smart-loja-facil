...
export const PRODUCTION_CHECKLIST: ProductionCheckItem[] = [
  ...
  },
  {
    ...
    expected: 'Versão pwa-supabase-v145-micro-interface-subabas e cache smart-loja-pwa-supabase-v145-micro-interface-subabas visíveis no celular.',
    tone: 'cache',
  },
  {
  ...
  },
  {
    ...
    expected: 'Versão pwa-supabase-v145-micro-interface-subabas, cache v145, roteiro guiado, execução real assistida, Supabase preservado e atualização multiaparelhos aparecem corretamente.',
    tone: 'cache',
  },
  {
