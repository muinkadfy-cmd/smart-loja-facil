...
export const PRODUCTION_CHECKLIST: ProductionCheckItem[] = [
  ...
  },
  {
    ...
    expected: 'Versão pwa-supabase-v153-auto-ajuste-iphone-android e cache smart-loja-pwa-supabase-v153-auto-ajuste-iphone-android visíveis no celular.',
    tone: 'cache',
  },
  {
  ...
  },
  {
    ...
    expected: 'Versão pwa-supabase-v153-auto-ajuste-iphone-android, cache v153, roteiro guiado, execução real assistida, Supabase preservado e atualização multiaparelhos aparecem corretamente.',
    tone: 'cache',
  },
  {
