...
const CHECKLIST_KEY = 'smart-loja:production-checklist-v137';
const LEGACY_CHECKLIST_KEYS: string[] = ['smart-loja:production-checklist-v136', 'smart-loja:production-checklist-v134', 'smart-loja:production-checklist-v130', 'smart-loja:production-checklist-v128', 'smart-loja:production-checklist-v127', 'smart-loja:production-checklist-v126'];

export const PRODUCTION_CHECKLIST: ProductionCheckItem[] = [
  {
    id: 'commercial-tour-v137',
  ...
  {
    id: 'final-commercial-acceptance-v137',
    group: 'Fechamento comercial',
  ...
  {
    id: 'guided-two-devices-v137',
    group: 'Validação guiada v137',
  ...
  {
    id: 'assisted-real-execution-v137',
    group: 'Execução real assistida v137',
  ...
  {
    id: 'pwa-cache-v137-installed',
    group: 'PWA e cache',
    title: 'Celular instalado recebeu v137',
    detail: 'Depois do deploy, abrir o PWA instalado, conferir v137 no Diagnóstico Web e limpar cache antigo se necessário.',
    expected: 'Versão pwa-supabase-v137-pos-venda-suporte e cache smart-loja-pwa-supabase-v137-pos-venda-suporte visíveis no celular.',
    tone: 'cache',
  },
  {
    id: 'commercial-clean-package-v137',
    group: 'Release comercial',
    title: 'Pacote comercial limpo sem banco de teste',
    detail: 'Rodar release:commercial:check e release:commercial:prepare antes de enviar para cliente depois da atualização v137.',
  ...
  {
    id: 'supabase-real-multi-device-v137',
...

  {
    ...
    expected: 'Sem master-ui ativo, CSS limpo v137 no diagnóstico e telas críticas preservadas.',
    tone: 'mobile',
  },
  {
  ...
  },
  {
    ...
    expected: 'Versão pwa-supabase-v137-pos-venda-suporte, cache v137, roteiro guiado, execução real assistida, Supabase preservado e atualização multiaparelhos aparecem corretamente.',
    tone: 'cache',
  },
  {
  ...
  },
  {
    ...
    expected: 'Diagnóstico mostra shell mobile v137, abas operacionais, alertas limpos ativos, sem corte lateral e com toque confortável no menu/dock.',
    tone: 'mobile',
  },
  {
    ...
    expected: 'Fundação mobile, componentes comerciais, alertas limpos e abas P1, roteiro e execução assistida v137 ativos; telas críticas marcadas só depois de conferência real.',
    tone: 'mobile',
  },
];
