...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v182.json');
...
process.stdout.write('Commercial release package v182 - Jaque Confeccoes e Presentes\n');
