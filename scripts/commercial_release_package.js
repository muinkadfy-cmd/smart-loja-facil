...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v225.json');
...
process.stdout.write('Commercial release package v225 - Jaque Confeccoes e Presentes\n');
