...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v234.json');
...
process.stdout.write('Commercial release package v234 - Jaque Confeccoes e Presentes\n');
