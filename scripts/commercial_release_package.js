...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v178.json');
...
process.stdout.write('Commercial release package v178 - Jaque Confeccoes e Presentes\n');
