...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v197.json');
...
process.stdout.write('Commercial release package v197 - Jaque Confeccoes e Presentes\n');
