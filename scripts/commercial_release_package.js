...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v196.json');
...
process.stdout.write('Commercial release package v196 - Jaque Confeccoes e Presentes\n');
