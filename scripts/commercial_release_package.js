...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v230.json');
...
process.stdout.write('Commercial release package v230 - Jaque Confeccoes e Presentes\n');
