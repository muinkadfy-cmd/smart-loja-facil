...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v242.json');
...
process.stdout.write('Commercial release package v242 - Jaque Confeccoes e Presentes\n');
