...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v235.json');
...
process.stdout.write('Commercial release package v235 - Jaque Confeccoes e Presentes\n');
