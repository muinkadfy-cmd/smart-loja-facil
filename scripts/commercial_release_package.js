...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v219.json');
...
process.stdout.write('Commercial release package v219 - Jaque Confeccoes e Presentes\n');
