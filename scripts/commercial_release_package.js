...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v127.json');
...
const manifest = {
  ...
  required_checks: [
    ...
    'Testar roteiro guiado v127 em dois aparelhos e papéis owner/admin/operator/viewer',
  ],
};
fs.writeFileSync(manifestPath, `${JSON.stringify(manifest, null, 2)}\n`);

process.stdout.write('Commercial release package v127 — Smart Loja Fácil\n');
