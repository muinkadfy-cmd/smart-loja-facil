...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v231.json');
...
process.stdout.write('Commercial release package v231 - Jaque Confeccoes e Presentes\n');
