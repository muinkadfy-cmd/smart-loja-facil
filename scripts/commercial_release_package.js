...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v181.json');
...
process.stdout.write('Commercial release package v181 - Jaque Confeccoes e Presentes\n');
