...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v179.json');
...
process.stdout.write('Commercial release package v179 - Jaque Confeccoes e Presentes\n');
