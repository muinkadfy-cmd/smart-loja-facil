...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v216.json');
...
process.stdout.write('Commercial release package v216 - Jaque Confeccoes e Presentes\n');
