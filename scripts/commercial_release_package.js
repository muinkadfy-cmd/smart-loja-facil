...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v236.json');
...
process.stdout.write('Commercial release package v236 - Jaque Confeccoes e Presentes\n');
