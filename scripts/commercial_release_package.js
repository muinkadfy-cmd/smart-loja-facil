...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v187.json');
...
process.stdout.write('Commercial release package v187 - Jaque Confeccoes e Presentes\n');
