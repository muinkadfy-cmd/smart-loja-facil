...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v133.json');
...
const manifest = {
  ...
  required_checks: [
    ...
    'Testar roteiro guiado, execução real assistida, aceite final e onboarding v133 em dois aparelhos e papéis owner/admin/operator/viewer',
  ],
};
fs.writeFileSync(manifestPath, `${JSON.stringify(manifest, null, 2)}\n`);

process.stdout.write('Commercial release package v133 — Smart Loja Fácil\n');
