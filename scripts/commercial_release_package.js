...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v233.json');
...
process.stdout.write('Commercial release package v233 - Jaque Confeccoes e Presentes\n');
