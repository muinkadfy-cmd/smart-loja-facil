...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v220.json');
...
process.stdout.write('Commercial release package v220 - Jaque Confeccoes e Presentes\n');
