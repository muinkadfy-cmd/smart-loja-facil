...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v214.json');
...
process.stdout.write('Commercial release package v214 - Jaque Confeccoes e Presentes\n');
