...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v194.json');
...
process.stdout.write('Commercial release package v194 - Jaque Confeccoes e Presentes\n');
