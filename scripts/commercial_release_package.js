...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v189.json');
...
process.stdout.write('Commercial release package v189 - Jaque Confeccoes e Presentes\n');
