...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v205.json');
...
process.stdout.write('Commercial release package v205 - Jaque Confeccoes e Presentes\n');
