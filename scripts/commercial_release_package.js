...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v232.json');
...
process.stdout.write('Commercial release package v232 - Jaque Confeccoes e Presentes\n');
