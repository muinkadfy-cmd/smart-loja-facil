...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v200.json');
...
process.stdout.write('Commercial release package v200 - Jaque Confeccoes e Presentes\n');
