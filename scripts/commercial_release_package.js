...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v141.json');
...
const manifest = {
  ...
  required_checks: [
    ...
    'Testar checklist de implantação real dia 1 v141, auditoria final, roteiro guiado, execução real assistida, aceite final e onboarding em dois aparelhos e papéis owner/admin/operator/viewer',
  ],
};
fs.writeFileSync(manifestPath, `${JSON.stringify(manifest, null, 2)}\n`);

process.stdout.write('Commercial release package v141 — Smart Loja Fácil\n');
