...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v195.json');
...
process.stdout.write('Commercial release package v195 - Jaque Confeccoes e Presentes\n');
