...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v218.json');
...
process.stdout.write('Commercial release package v218 - Jaque Confeccoes e Presentes\n');
