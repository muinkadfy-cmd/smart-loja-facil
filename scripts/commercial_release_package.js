...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v126.json');
...
const manifest = {
  ...
  required_checks: [
    ...
    'Testar dois aparelhos, atualização automática e papéis owner/admin/operator/viewer',
  ],
};
fs.writeFileSync(manifestPath, `${JSON.stringify(manifest, null, 2)}\n`);

process.stdout.write('Commercial release package v126 — Smart Loja Fácil\n');
