...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v209.json');
...
process.stdout.write('Commercial release package v209 - Jaque Confeccoes e Presentes\n');
