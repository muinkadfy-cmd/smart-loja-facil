...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v227.json');
...
process.stdout.write('Commercial release package v227 - Jaque Confeccoes e Presentes\n');
