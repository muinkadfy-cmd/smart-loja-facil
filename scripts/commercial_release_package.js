...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v226.json');
...
process.stdout.write('Commercial release package v226 - Jaque Confeccoes e Presentes\n');
