...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v210.json');
...
process.stdout.write('Commercial release package v210 - Jaque Confeccoes e Presentes\n');
