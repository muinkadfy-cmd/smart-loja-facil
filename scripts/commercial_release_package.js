...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v198.json');
...
process.stdout.write('Commercial release package v198 - Jaque Confeccoes e Presentes\n');
