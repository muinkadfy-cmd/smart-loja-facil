...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v212.json');
...
process.stdout.write('Commercial release package v212 - Jaque Confeccoes e Presentes\n');
