...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v192.json');
...
process.stdout.write('Commercial release package v192 - Jaque Confeccoes e Presentes\n');
