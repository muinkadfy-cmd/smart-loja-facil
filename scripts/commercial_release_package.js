...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v229.json');
...
process.stdout.write('Commercial release package v229 - Jaque Confeccoes e Presentes\n');
