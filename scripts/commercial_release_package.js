...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v206.json');
...
process.stdout.write('Commercial release package v206 - Jaque Confeccoes e Presentes\n');
