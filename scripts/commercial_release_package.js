...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v185.json');
...
process.stdout.write('Commercial release package v185 - Jaque Confeccoes e Presentes\n');
