...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v202.json');
...
process.stdout.write('Commercial release package v202 - Jaque Confeccoes e Presentes\n');
