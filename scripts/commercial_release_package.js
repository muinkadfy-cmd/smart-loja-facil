...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v211.json');
...
process.stdout.write('Commercial release package v211 - Jaque Confeccoes e Presentes\n');
