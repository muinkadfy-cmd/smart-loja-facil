...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v228.json');
...
process.stdout.write('Commercial release package v228 - Jaque Confeccoes e Presentes\n');
