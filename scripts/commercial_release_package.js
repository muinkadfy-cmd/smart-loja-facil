...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v199.json');
...
process.stdout.write('Commercial release package v199 - Jaque Confeccoes e Presentes\n');
