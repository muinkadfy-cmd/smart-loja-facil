...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v184.json');
...
process.stdout.write('Commercial release package v184 - Jaque Confeccoes e Presentes\n');
