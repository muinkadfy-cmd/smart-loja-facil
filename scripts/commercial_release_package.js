...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v96.json');
...
const manifest = {
  ...
  required_checks: [
    ...
    'Testar dois aparelhos e papéis owner/admin/operator/viewer',
  ],
};
fs.writeFileSync(manifestPath, `${JSON.stringify(manifest, null, 2)}\n`);

process.stdout.write('Commercial release package v96 — Smart Loja Fácil\n');
