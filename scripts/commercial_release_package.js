...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v240.json');
...
process.stdout.write('Commercial release package v240 - Jaque Confeccoes e Presentes\n');
