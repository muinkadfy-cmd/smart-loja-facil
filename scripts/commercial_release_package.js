...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v215.json');
...
process.stdout.write('Commercial release package v215 - Jaque Confeccoes e Presentes\n');
