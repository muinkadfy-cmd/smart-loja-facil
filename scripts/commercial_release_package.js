...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v217.json');
...
process.stdout.write('Commercial release package v217 - Jaque Confeccoes e Presentes\n');
