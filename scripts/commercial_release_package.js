...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v191.json');
...
process.stdout.write('Commercial release package v191 - Jaque Confeccoes e Presentes\n');
