...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v241.json');
...
process.stdout.write('Commercial release package v241 - Jaque Confeccoes e Presentes\n');
