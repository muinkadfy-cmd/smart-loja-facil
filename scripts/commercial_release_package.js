...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v180.json');
...
process.stdout.write('Commercial release package v180 - Jaque Confeccoes e Presentes\n');
