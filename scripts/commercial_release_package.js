...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v208.json');
...
process.stdout.write('Commercial release package v208 - Jaque Confeccoes e Presentes\n');
