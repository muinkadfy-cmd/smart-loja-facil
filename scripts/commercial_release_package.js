...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v239.json');
...
process.stdout.write('Commercial release package v239 - Jaque Confeccoes e Presentes\n');
