...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v193.json');
...
process.stdout.write('Commercial release package v193 - Jaque Confeccoes e Presentes\n');
