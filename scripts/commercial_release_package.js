...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v186.json');
...
process.stdout.write('Commercial release package v186 - Jaque Confeccoes e Presentes\n');
