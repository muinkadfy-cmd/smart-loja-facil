...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v175.json');
...
process.stdout.write('Commercial release package v175 — Jaque Confecções e Presentes\n');
