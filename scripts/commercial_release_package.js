...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v188.json');
...
process.stdout.write('Commercial release package v188 - Jaque Confeccoes e Presentes\n');
