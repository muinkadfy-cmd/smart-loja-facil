...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v213.json');
...
process.stdout.write('Commercial release package v213 - Jaque Confeccoes e Presentes\n');
