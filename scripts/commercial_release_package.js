...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v207.json');
...
process.stdout.write('Commercial release package v207 - Jaque Confeccoes e Presentes\n');
