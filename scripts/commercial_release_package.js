...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v203.json');
...
process.stdout.write('Commercial release package v203 - Jaque Confeccoes e Presentes\n');
