...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v204.json');
...
process.stdout.write('Commercial release package v204 - Jaque Confeccoes e Presentes\n');
