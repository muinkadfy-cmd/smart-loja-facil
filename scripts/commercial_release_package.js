...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v201.json');
...
process.stdout.write('Commercial release package v201 - Jaque Confeccoes e Presentes\n');
