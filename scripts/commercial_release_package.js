...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v177.json');
...
process.stdout.write('Commercial release package v177 - Jaque Confeccoes e Presentes\n');
