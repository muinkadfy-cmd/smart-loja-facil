...
const manifestPath = path.join(outRoot, 'commercial-release-manifest-v183.json');
...
process.stdout.write('Commercial release package v183 - Jaque Confeccoes e Presentes\n');
