...
const currentVersion = 'pwa-supabase-v209-crediario-facil-usuario-leigo';
const currentCache = 'smart-loja-pwa-supabase-v209-crediario-facil-usuario-leigo';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v209 crediario facil usuario leigo.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v209 crediario facil usuario leigo.');
...
console.log('OK: release_check v209 PWA passou. crediario facil usuario leigo e icones vetoriais conferidos.');
