...
const currentVersion = 'pwa-supabase-v182-vendas-comprovante-pdf-png';
const currentCache = 'smart-loja-pwa-supabase-v182-vendas-comprovante-pdf-png';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v182 vendas comprovante PDF PNG.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v182 vendas comprovante PDF PNG.');
...
console.log('OK: release_check v182 PWA passou. PNG fiel ao PDF conferido.');
