...
const currentVersion = 'pwa-supabase-v237-crediario-expansivel-completo';
const currentCache = 'smart-loja-pwa-supabase-v237-crediario-expansivel-completo';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v237 crediario expansivel completo.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v237 crediario expansivel completo.');
...
console.log('OK: release_check v237 PWA passou. Crediário expansível completo conferido.');
