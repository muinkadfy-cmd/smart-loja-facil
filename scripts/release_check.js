...
const currentVersion = 'pwa-supabase-v204-remover-card-aberta';
const currentCache = 'smart-loja-pwa-supabase-v204-remover-card-aberta';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v204 remover card aberta.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v204 remover card aberta.');
...
console.log('OK: release_check v204 PWA passou. remover card aberta e icones vetoriais conferidos.');
