...
const currentVersion = 'pwa-supabase-v166-pdf-real-logo-mobile';
const currentCache = 'smart-loja-pwa-supabase-v166-pdf-real-logo-mobile';
...
if (!mainSource.includes('smart-mobile-rebuild-v166')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v166.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v166 pdf real logo mobile.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v166 pdf real logo mobile.');
...
console.log('OK: release_check v166 PWA passou. Comprovantes/Crediário com PDF real, visualizar mobile e logo premium conferidos.');
