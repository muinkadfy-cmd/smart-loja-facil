...
const currentVersion = 'pwa-supabase-v159-crediario-notas-comprovantes';
const currentCache = 'smart-loja-pwa-supabase-v159-crediario-notas-comprovantes';
...
if (!mainSource.includes('smart-mobile-rebuild-v159')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v159.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v159 crediario notas comprovantes.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v159 crediario notas comprovantes.');
...
console.log('OK: release_check v159 PWA passou. Crediário, notas, comprovantes por parcela, Central de avisos e mobile conferidos.');
