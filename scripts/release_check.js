...
const currentVersion = 'pwa-supabase-v239-editar-data-qualquer-parcela';
const currentCache = 'smart-loja-pwa-supabase-v239-editar-data-qualquer-parcela';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v239 editar data qualquer parcela.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v239 editar data qualquer parcela.');
...
console.log('OK: release_check v239 PWA passou. Editar data de qualquer parcela conferido.');
