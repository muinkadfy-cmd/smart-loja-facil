...
const currentVersion = 'pwa-supabase-v225-realinhar-versao-auditoria';
const currentCache = 'smart-loja-pwa-supabase-v225-realinhar-versao-auditoria';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v225 realinhar versao auditoria.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v225 realinhar versao auditoria.');
...
console.log('OK: release_check v225 PWA passou. realinhar versao auditoria e icones vetoriais conferidos.');
