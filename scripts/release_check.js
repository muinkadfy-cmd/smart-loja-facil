...
const currentVersion = 'pwa-supabase-v232-status-com-espaco';
const currentCache = 'smart-loja-pwa-supabase-v232-status-com-espaco';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v232 status com espaco.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v232 status com espaco.');
...
console.log('OK: release_check v232 PWA passou. Status com espaço em extrato/comprovante conferido.');
