...
const currentVersion = 'pwa-supabase-v181-vendas-comprovante-pdf-png';
const currentCache = 'smart-loja-pwa-supabase-v181-vendas-comprovante-pdf-png';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v181 vendas comprovante PDF PNG.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v181 vendas comprovante PDF PNG.');
...
console.log('OK: release_check v181 PWA passou. Vendas e comprovantes PDF/PNG conferidos.');
