...
const currentVersion = 'pwa-supabase-v216-pdv-mobile-dashboard-premium';
const currentCache = 'smart-loja-pwa-supabase-v216-pdv-mobile-dashboard-premium';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v216 pdv mobile dashboard premium.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v216 pdv mobile dashboard premium.');
...
console.log('OK: release_check v216 PWA passou. pdv mobile dashboard premium e icones vetoriais conferidos.');
