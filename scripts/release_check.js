...
const currentVersion = 'pwa-supabase-v196-comprovante-fiel-referencia';
const currentCache = 'smart-loja-pwa-supabase-v196-comprovante-fiel-referencia';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v196 comprovante fiel referencia.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v196 comprovante fiel referencia.');
...
console.log('OK: release_check v196 PWA passou. comprovante fiel referencia e icones vetoriais conferidos.');
