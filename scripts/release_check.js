...
const currentVersion = 'pwa-supabase-v198-comprovante-top-ajuste-aberta';
const currentCache = 'smart-loja-pwa-supabase-v198-comprovante-top-ajuste-aberta';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v198 comprovante top ajuste aberta.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v198 comprovante top ajuste aberta.');
...
console.log('OK: release_check v198 PWA passou. comprovante top ajuste aberta e icones vetoriais conferidos.');
