...
const currentVersion = 'pwa-supabase-v194-extrato-fiel-central-avisos';
const currentCache = 'smart-loja-pwa-supabase-v194-extrato-fiel-central-avisos';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v194 extrato fiel central avisos.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v194 extrato fiel central avisos.');
...
console.log('OK: release_check v194 PWA passou. extrato fiel, PNG/PDF/compartilhar e central de avisos v2 conferidos.');
