...
const currentVersion = 'pwa-supabase-v151-login-central-profissional';
const currentCache = 'smart-loja-pwa-supabase-v151-login-central-profissional';
...
if (!mainSource.includes('smart-mobile-rebuild-v151')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v151.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v151 login central profissional.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v151 login central profissional.');
...
console.log('OK: release_check v151 PWA passou. Auditoria e proteção de backup, fotos de produtos, histórico e Storage product-photos, mantendo encerramento, Dia 1/Dia 2, auditoria final, painel executivo, feedback/NPS, pós-venda, termo, proposta, tour, treinamento, onboarding e Supabase preservados.');
