...
const currentVersion = 'pwa-supabase-v200-sora-comprovantes-unificados';
const currentCache = 'smart-loja-pwa-supabase-v200-sora-comprovantes-unificados';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v200 sora comprovantes unificados.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v200 sora comprovantes unificados.');
...
console.log('OK: release_check v200 PWA passou. sora comprovantes unificados e icones vetoriais conferidos.');
