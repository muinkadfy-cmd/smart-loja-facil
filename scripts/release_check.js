...
const currentVersion = 'pwa-supabase-v188-comprovantes-acoes-fontes';
const currentCache = 'smart-loja-pwa-supabase-v188-comprovantes-acoes-fontes';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v188 comprovantes ações fontes.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v188 comprovantes ações fontes.');
...
console.log('OK: release_check v188 PWA passou. comprovantes PDF/PNG e ações padronizadas conferidos.');
