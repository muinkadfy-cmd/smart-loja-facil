...
const currentVersion = 'pwa-supabase-v229-comprovantes-micro-alinhamento';
const currentCache = 'smart-loja-pwa-supabase-v229-comprovantes-micro-alinhamento';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v229 comprovantes micro alinhamento.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v229 comprovantes micro alinhamento.');
...
console.log('OK: release_check v229 PWA passou. comprovantes micro alinhamento e icones vetoriais conferidos.');
