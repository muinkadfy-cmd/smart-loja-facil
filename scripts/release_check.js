...
const currentVersion = 'pwa-supabase-v187-produtos-legiveis-comprovantes';
const currentCache = 'smart-loja-pwa-supabase-v187-produtos-legiveis-comprovantes';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v187 produtos legíveis nos comprovantes.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v187 produtos legíveis nos comprovantes.');
...
console.log('OK: release_check v187 PWA passou. comprovantes PDF/PNG com produtos mais legíveis conferidos.');
