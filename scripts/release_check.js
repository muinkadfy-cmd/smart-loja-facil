...
const currentVersion = 'pwa-supabase-v228-extratos-premium-legiveis';
const currentCache = 'smart-loja-pwa-supabase-v228-extratos-premium-legiveis';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v228 extratos premium legiveis.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v228 extratos premium legiveis.');
...
console.log('OK: release_check v228 PWA passou. extratos premium legiveis e icones vetoriais conferidos.');
