...
const currentVersion = 'pwa-supabase-v233-status-com-espaco';
const currentCache = 'smart-loja-pwa-supabase-v233-status-com-espaco';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v233 hotfix typecheck crediario.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v233 hotfix typecheck crediario.');
...
console.log('OK: release_check v233 PWA passou. Hotfix TypeScript do crediário conferido.');
