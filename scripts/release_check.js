...
const currentVersion = 'pwa-supabase-v193-cupom-micro-ajuste-acima';
const currentCache = 'smart-loja-pwa-supabase-v193-cupom-micro-ajuste-acima';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v193 cupom micro ajuste acima.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v193 cupom micro ajuste acima.');
...
console.log('OK: release_check v193 PWA passou. cupom PNG micro ajustado para cima e campos protegidos conferidos.');
