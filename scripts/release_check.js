...
const currentVersion = 'pwa-supabase-v147-alertas-logout-polimento';
const currentCache = 'smart-loja-pwa-supabase-v147-alertas-logout-polimento';
...
if (!mainSource.includes('smart-mobile-rebuild-v147')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v147.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v147 alertas logout polimento.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v147 alertas logout polimento.');
...
console.log('OK: release_check v147 PWA passou. Auditoria e proteção de backup, fotos de produtos, histórico e Storage product-photos, mantendo encerramento, Dia 1/Dia 2, auditoria final, painel executivo, feedback/NPS, pós-venda, termo, proposta, tour, treinamento, onboarding e Supabase preservados.');
