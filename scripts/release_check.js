...
const currentVersion = 'pwa-supabase-v227-crediario-clareza-total';
const currentCache = 'smart-loja-pwa-supabase-v227-crediario-clareza-total';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v227 crediario clareza total.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v227 crediario clareza total.');
...
console.log('OK: release_check v227 PWA passou. crediario clareza total e icones vetoriais conferidos.');
