...
const currentVersion = 'pwa-supabase-v192-cupom-centralizado-seguro';
const currentCache = 'smart-loja-pwa-supabase-v192-cupom-centralizado-seguro';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v192 cupom centralizado seguro.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v192 cupom centralizado seguro.');
...
console.log('OK: release_check v192 PWA passou. cupom PNG centralizado e campos protegidos conferidos.');
