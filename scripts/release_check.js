...
const currentVersion = 'pwa-supabase-v178-alertas-rotas-icone-flor';
const currentCache = 'smart-loja-pwa-supabase-v178-alertas-rotas-icone-flor';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v178 alertas rotas icone flor.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v178 alertas rotas icone flor.');
...
console.log('OK: release_check v178 PWA passou. Alertas externos com rota direta conferidos.');
