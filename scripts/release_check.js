...
const currentVersion = 'pwa-supabase-v217-pdv-mobile-compacto-5-produtos';
const currentCache = 'smart-loja-pwa-supabase-v217-pdv-mobile-compacto-5-produtos';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v217 pdv mobile compacto 5 produtos.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v217 pdv mobile compacto 5 produtos.');
...
console.log('OK: release_check v217 PWA passou. pdv mobile compacto 5 produtos e icones vetoriais conferidos.');
