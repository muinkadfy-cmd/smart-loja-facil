...
const currentVersion = 'pwa-supabase-v155-produto-assistido-crediario-foto';
const currentCache = 'smart-loja-pwa-supabase-v155-produto-assistido-crediario-foto';
...
if (!mainSource.includes('smart-mobile-rebuild-v155')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v155.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v155 produto assistido, foto maior e crediário.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v155 produto assistido, foto maior e crediário.');
...
console.log('OK: release_check v155 PWA passou. Produto assistido, fotos maiores comprimidas, backup de fotos e crediário parcelado conferidos, mantendo Supabase e dados críticos preservados.');
