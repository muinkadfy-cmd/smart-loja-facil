...
const currentVersion = 'pwa-supabase-v158-relatorios-comprovantes-logs';
const currentCache = 'smart-loja-pwa-supabase-v158-relatorios-comprovantes-logs';
...
if (!mainSource.includes('smart-mobile-rebuild-v158')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v158.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v158 relatórios comprovantes logs.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v158 relatórios comprovantes logs.');
...
console.log('OK: release_check v158 PWA passou. Relatórios, comprovantes, logs, Central de avisos e mobile conferidos.');
