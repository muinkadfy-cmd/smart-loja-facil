...
const currentVersion = 'pwa-supabase-v203-sora-sem-fonte-quebrada';
const currentCache = 'smart-loja-pwa-supabase-v203-sora-sem-fonte-quebrada';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v203 sora sem fonte quebrada.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v203 sora sem fonte quebrada.');
...
console.log('OK: release_check v203 PWA passou. sora sem fonte quebrada e icones vetoriais conferidos.');
