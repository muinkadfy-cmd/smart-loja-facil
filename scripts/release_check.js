...
const currentVersion = 'pwa-supabase-v206-comprovante-crediario-alinhado';
const currentCache = 'smart-loja-pwa-supabase-v206-comprovante-crediario-alinhado';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v206 comprovante crediario alinhado.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v206 comprovante crediario alinhado.');
...
console.log('OK: release_check v206 PWA passou. comprovante crediario alinhado e icones vetoriais conferidos.');
