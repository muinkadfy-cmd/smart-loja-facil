...
const currentVersion = 'pwa-supabase-v148-backup-alertas-polidos';
const currentCache = 'smart-loja-pwa-supabase-v148-backup-alertas-polidos';
...
if (!mainSource.includes('smart-mobile-rebuild-v148')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v148.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v148 backup alertas polidos.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v148 backup alertas polidos.');
...
console.log('OK: release_check v148 PWA passou. Auditoria e proteção de backup, fotos de produtos, histórico e Storage product-photos, mantendo encerramento, Dia 1/Dia 2, auditoria final, painel executivo, feedback/NPS, pós-venda, termo, proposta, tour, treinamento, onboarding e Supabase preservados.');
