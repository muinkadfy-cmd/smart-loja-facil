...
const currentVersion = 'pwa-supabase-v150-header-loja-polido';
const currentCache = 'smart-loja-pwa-supabase-v150-header-loja-polido';
...
if (!mainSource.includes('smart-mobile-rebuild-v150')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v150.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v150 header loja polido.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v150 header loja polido.');
...
console.log('OK: release_check v150 PWA passou. Auditoria e proteção de backup, fotos de produtos, histórico e Storage product-photos, mantendo encerramento, Dia 1/Dia 2, auditoria final, painel executivo, feedback/NPS, pós-venda, termo, proposta, tour, treinamento, onboarding e Supabase preservados.');
