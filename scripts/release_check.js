...
const currentVersion = 'pwa-supabase-v205-extrato-sem-anotacoes';
const currentCache = 'smart-loja-pwa-supabase-v205-extrato-sem-anotacoes';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v205 extrato sem anotacoes.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v205 extrato sem anotacoes.');
...
console.log('OK: release_check v205 PWA passou. extrato sem anotacoes e icones vetoriais conferidos.');
