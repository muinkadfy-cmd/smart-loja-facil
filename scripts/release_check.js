...
const currentVersion = 'pwa-supabase-v195-avisos-responsivo-comprovante-sem-texto';
const currentCache = 'smart-loja-pwa-supabase-v195-avisos-responsivo-comprovante-sem-texto';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v195 avisos responsivo comprovante sem texto.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v195 avisos responsivo comprovante sem texto.');
...
console.log('OK: release_check v195 PWA passou. central responsiva e comprovante sem texto/link conferidos.');
