...
const currentVersion = 'pwa-supabase-v214-padrao-compacto-premium-abas';
const currentCache = 'smart-loja-pwa-supabase-v214-padrao-compacto-premium-abas';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v214 padrao compacto premium abas.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v214 padrao compacto premium abas.');
...
console.log('OK: release_check v214 PWA passou. padrao compacto premium abas e icones vetoriais conferidos.');
