...
const currentVersion = 'pwa-supabase-v199-comprovante-tipografia-aberta';
const currentCache = 'smart-loja-pwa-supabase-v199-comprovante-tipografia-aberta';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v199 comprovante tipografia aberta.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v199 comprovante tipografia aberta.');
...
console.log('OK: release_check v199 PWA passou. comprovante tipografia aberta e icones vetoriais conferidos.');
