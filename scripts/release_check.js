...
const currentVersion = 'pwa-supabase-v220-comprovantes-tipografia-legivel';
const currentCache = 'smart-loja-pwa-supabase-v220-comprovantes-tipografia-legivel';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v220 comprovantes tipografia legivel.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v220 comprovantes tipografia legivel.');
...
console.log('OK: release_check v220 PWA passou. comprovantes tipografia legivel e icones vetoriais conferidos.');
