...
const currentVersion = 'pwa-supabase-v226-comprovantes-legiveis-10x';
const currentCache = 'smart-loja-pwa-supabase-v226-comprovantes-legiveis-10x';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v226 comprovantes legiveis 10x.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v226 comprovantes legiveis 10x.');
...
console.log('OK: release_check v226 PWA passou. comprovantes legiveis 10x e icones vetoriais conferidos.');
