...
const currentVersion = 'pwa-supabase-v236-status-com-espaco';
const currentCache = 'smart-loja-pwa-supabase-v236-status-com-espaco';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v236 crediario parcelas expansivel.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v236 crediario parcelas expansivel.');
...
console.log('OK: release_check v236 PWA passou. Crediário parcelas expansível conferido.');
