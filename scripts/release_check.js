...
const currentVersion = 'pwa-supabase-v172-pdf-fiel-compartilhar-arquivo';
const currentCache = 'smart-loja-pwa-supabase-v172-pdf-fiel-compartilhar-arquivo';
...
if (!mainSource.includes('smart-mobile-rebuild-v172')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v172.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v172 PDF manual crediário rápido.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v172 PDF manual crediário rápido.');
...
console.log('OK: release_check v172 PWA passou. PDF fiel preto/branco e compartilhamento de arquivo conferidos.');
