...
const currentVersion = 'pwa-supabase-v197-comprovante-fiel-margens-ajustadas';
const currentCache = 'smart-loja-pwa-supabase-v197-comprovante-fiel-margens-ajustadas';
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v197 comprovante fiel margens ajustadas.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v197 comprovante fiel margens ajustadas.');
...
console.log('OK: release_check v197 PWA passou. comprovante fiel margens ajustadas e icones vetoriais conferidos.');
