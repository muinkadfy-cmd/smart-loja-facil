...
const currentVersion = 'pwa-supabase-v160-comprovantes-premium-iphone';
const currentCache = 'smart-loja-pwa-supabase-v160-comprovantes-premium-iphone';
...
if (!mainSource.includes('smart-mobile-rebuild-v160')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v160.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v160 comprovantes premium iphone.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v160 comprovantes premium iphone.');
...
console.log('OK: release_check v160 PWA passou. Comprovantes premium, logo, iPhone, Central de avisos e mobile conferidos.');
