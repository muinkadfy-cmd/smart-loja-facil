...
const currentVersion = 'pwa-supabase-v173-pdf-polido-loja-cadastrada';
const currentCache = 'smart-loja-pwa-supabase-v173-pdf-polido-loja-cadastrada';
...
if (!mainSource.includes('smart-mobile-rebuild-v173')) fail('main.tsx precisa aplicar a classe smart-mobile-rebuild-v173.');
...
if (!webApiSource.includes(currentCache)) fail('WEB_CACHE_VERSION precisa estar no cache v173 PDF polido loja cadastrada.');
if (!serviceWorkerSource.includes(currentCache)) fail('Service worker precisa usar cache v173 PDF polido loja cadastrada.');
...
console.log('OK: release_check v173 PWA passou. PDF polido com nome da loja cadastrada conferidos.');
